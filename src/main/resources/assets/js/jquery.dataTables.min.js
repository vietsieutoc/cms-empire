...
!(function (a) {
  ...
  function g(a) {
    ...
    !a.sEmptyTable &&
      ...
      Ja(a, a, "sZeroRecords", "sEmptyTable"),
      !a.sLoadingRecords &&
        c &&
        "Loading..." === b.sLoadingRecords &&
        Ja(a, a, "sZeroRecords", "sLoadingRecords"),
  ...
  function j(b) {
    if (!Ua.__browser) {
      ...
      (c.barWidth = e[0].offsetWidth - e[0].clientWidth),
        (c.bScrollOversize =
          100 === f[0].offsetWidth && 100 !== e[0].clientWidth),
    ...
    if (0 !== l.length)
      for (var o = k ? 0 : m, p = k ? b.aoData.length : n, r = o; p > r; r++) {
        ...
        if (0 !== h) {
          var v = g[f % h];
          t._sRowStripe != v &&
            (a(u).removeClass(t._sRowStripe).addClass(v), (t._sRowStripe = v));
        }
  ...
  function R(b, c, d) {
    ...
    var l = {
      ...
      error: function (c, d, e) {
        ...
        -1 === a.inArray(!0, f) &&
          ("parsererror" == d
            ? Ia(b, 0, "Invalid JSON response", 1)
            : 4 === c.readyState && Ia(b, 0, "Ajax error", 7)),
          oa(b, !1);
      },
    };
    (b.oAjaxData = c),
      ...
      if (((i = a.aoData[c]), !i._aFilterData)) {
        for (g = [], d = 0, f = j.length; f > d; d++)
          (b = j[d]),
            ...
            h.indexOf &&
              -1 !== h.indexOf("&") &&
              ((tb.innerHTML = h), (h = ub ? tb.textContent : tb.innerText)),
  ...
  function ea(b) {
    ...
    return (
      d ||
        (b.aoDrawCallback.push({ fn: fa, sName: "information" }),
  ...
  function ma(a, b, c) {
    ...
    return (
      (a._iDisplayStart = d), g && (Na(a, null, "page", [a]), c && M(a)), g
    );
  }
  function na(b) {
    return a("<div/>", {
  ...
  function sa(c) {
    ...
    for (y && -1 !== y.indexOf("%") && (t = y), d = 0; d < p.length; d++)
      (e = h[p[d]]),
        null !== e.sWidth && ((e.sWidth = ua(e.sWidthOrig, u)), (v = !0));
  ...
  function Ea(a, b) {
    ...
    for (
      var f,
        g,
        h = Ua.ext.type.order[d.sType + "-pre"],
        i = 0,
        j = a.aoData.length;
      j > i;
      i++
  ...
  function Ta(a) {
    return function () {
      var b = [Ha(this[Ua.ext.iApiIndex])].concat(
  ...
  Ua = function (b) {
    ...
    return (
      this.each(function () {
        ...
        (null !== r && "" !== r) ||
          ((r = "DataTables_Table_" + Ua.ext._unique++), (this.id = r));
  ...
  Xa("tables()", function (a) {
    ...
    Xa("draw()", function (a) {
      return this.iterator("table", function (b) {
        "page" === a
          ? M(b)
          : ("string" == typeof a && (a = "full-hold" !== a), N(b, a === !1));
      });
    }),
    Xa("page()", function (a) {
      return a === d
  ...
  Xa(Mb, function (a, b) {
    ...
    return a === d
      ...
      : (a === !0
          ...
          : a === !1
          ? Hb(this)
          : c.length && this.length && Gb(c[0], c[0].aoData[this[0]], a, b),
        this);
  }),
  ...
  a.extend(Sb, {
    ...
    a.extend(Ua.ext.type.detect, [
      ...
      function (a, b) {
        return eb(a) || ("string" == typeof a && -1 !== a.indexOf("<"))
          ? "html"
          : null;
      },
    ]),
